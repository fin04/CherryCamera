...
public class cCameraMenuSet implements OnClickListener, RadioGroup.OnCheckedChangeListener
    ...
    public void btnSet() {
        ...
        if(appClass.ListFlashMode == null){
            (appClass.getActivity().findViewById(R.id.btn_camera_flash)).setVisibility(View.GONE);
        }else{
            appClass.getActivity().findViewById(R.id.btn_camera_flash).setOnClickListener(this);
        }

        appClass.getActivity().findViewById(R.id.btn_camera_barcode).setOnClickListener(this);
        if(appClass.ListColorEffect.size() <= 1){
            (appClass.getActivity().findViewById(R.id.btn_camera_effect
            )).setVisibility(View.GONE);
        }else{
            appClass.getActivity().findViewById(R.id.btn_camera_effect).setOnClickListener(this);
        }
...
//			iv.setVisibility(View.GONE);
            ...
            if (!appClass.ListFlashMode.contains(Parameters.FLASH_MODE_AUTO))
                flash_rg.removeViewInLayout(appClass.getActivity().findViewById(R.id.flash_radio0));
            if (!appClass.ListFlashMode.contains(Parameters.FLASH_MODE_ON))
                flash_rg.removeViewInLayout(appClass.getActivity().findViewById(R.id.flash_radio1));
            if (!appClass.ListFlashMode.contains(Parameters.FLASH_MODE_OFF))
                flash_rg.removeViewInLayout(appClass.getActivity().findViewById(R.id.flash_radio2));
            if (!appClass.ListFlashMode.contains(Parameters.FLASH_MODE_RED_EYE))
                flash_rg.removeViewInLayout(appClass.getActivity().findViewById(R.id.flash_radio3));
            if (!appClass.ListFlashMode.contains(Parameters.FLASH_MODE_TORCH))
                flash_rg.removeViewInLayout(appClass.getActivity().findViewById(R.id.flash_radio4));
        ...
        if (appClass.ListFocus == null) {
            ...
            if (!appClass.ListFocus.contains(Parameters.FOCUS_MODE_AUTO))
                focus_rg.removeViewInLayout(appClass.getActivity().findViewById(R.id.focus_radio0));
            if (!appClass.ListFocus.contains(Parameters.FOCUS_MODE_MACRO))
                focus_rg.removeViewInLayout(appClass.getActivity().findViewById(R.id.focus_radio1));
            if (!appClass.ListFocus.contains(Parameters.FOCUS_MODE_INFINITY))
                focus_rg.removeViewInLayout(appClass.getActivity().findViewById(R.id.focus_radio2));
            if (!appClass.ListFocus.contains(Parameters.FOCUS_MODE_FIXED))
                focus_rg.removeViewInLayout(appClass.getActivity().findViewById(R.id.focus_radio3));
...
//			vf.showNext();
                if (params.getFlashMode().contains(Parameters.FLASH_MODE_AUTO))
                    flash_rg.check(R.id.flash_radio0);
                else if (params.getFlashMode().contains(Parameters.FLASH_MODE_ON))
                    flash_rg.check(R.id.flash_radio1);
                else if (params.getFlashMode().contains(Parameters.FLASH_MODE_OFF))
                    flash_rg.check(R.id.flash_radio2);
                else if (params.getFlashMode().contains(Parameters.FLASH_MODE_RED_EYE))
                    flash_rg.check(R.id.flash_radio3);
                else if (params.getFlashMode().contains(Parameters.FLASH_MODE_TORCH))
                    flash_rg.check(R.id.flash_radio4);
...
//			vf.setOutAnimation(ccUtil.outToRightAnimation());
//			vf.showNext();
                if (params.getFocusMode().contains(Parameters.FOCUS_MODE_AUTO))
                    focus_rg.check(R.id.focus_radio0);
                else if (params.getFocusMode().contains(Parameters.FOCUS_MODE_MACRO))
                    focus_rg.check(R.id.focus_radio1);
                else if (params.getFocusMode().contains(Parameters.FOCUS_MODE_INFINITY))
                    focus_rg.check(R.id.focus_radio2);
                else if (params.getFocusMode().contains(Parameters.FOCUS_MODE_FIXED))
                    focus_rg.check(R.id.focus_radio3);
...
//				optionTitleText.setText(R.string.camera_option);
            ...
            case R.id.btn_camera_face:
                ...
                appClass.mPreview.isButtonSetting = false;
...
//                } else {
//                    if (appClass.ListFocus == null ||
//                            params.getFocusMode().equals(Parameters.FOCUS_MODE_FIXED)) {
//                    } else {
